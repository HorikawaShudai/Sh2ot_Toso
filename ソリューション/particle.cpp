	...
	for (int nCntParticle = 0; nCntParticle < MAX_PARTICLE; nCntParticle++)
	{
		if (g_aParticle[nCntParticle].bUse == true)
		{
			for (int nCntAppear = 0; nCntAppear < g_aParticle[nCntParticle].nEffect; nCntAppear++)
			{
				...
				SetEffect(g_aParticle[nCntParticle].pos, g_aParticle[nCntParticle].col, g_aParticle[nCntParticle].move, g_aParticle[nCntParticle].fRadius, g_aParticle[nCntParticle].nEffectLife, g_aParticle[nCntParticle].nType);
